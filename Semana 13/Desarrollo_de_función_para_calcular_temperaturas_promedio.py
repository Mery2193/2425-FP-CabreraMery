...
temperaturas = [
    [  # Ciudad: Loja
        [22, 23, 24, 25, 26, 27, 28],  # Semana 1: Lunes - Domingo
        [21, 22, 23, 24, 25, 26, 27],  # Semana 2: Lunes - Domingo
        [20, 21, 22, 23, 24, 25, 26],  # Semana 3: Lunes - Domingo
        [19, 20, 21, 22, 23, 24, 25]   # Semana 4: Lunes - Domingo
    ],
    [  # Ciudad: Ambato
        [18, 19, 20, 21, 22, 23, 24],  # Semana 1: Lunes - Domingo
        [17, 18, 19, 20, 21, 22, 23],  # Semana 2: Lunes - Domingo
        [21, 22, 23, 24, 25, 26, 27],  # Semana 3: Lunes - Domingo
        [20, 21, 22, 23, 24, 25, 26]   # Semana 4: Lunes - Domingo
    ],
    [  # Ciudad: Manta
        [28, 29, 30, 31, 32, 33, 34],  # Semana 1: Lunes - Domingo
        [27, 28, 29, 30, 31, 32, 33],  # Semana 2: Lunes - Domingo
        [30, 31, 32, 33, 34, 35, 36],  # Semana 3: Lunes - Domingo
        [29, 30, 31, 32, 33, 34, 35]   # Semana 4: Lunes - Domingo
    ]
]
